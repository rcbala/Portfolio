  ...
  return (
    <div className="container mt-2  ">
      ...
      <div className="d-flex justify-content-center">
        <Row xs={1} md={2} className="g-3 mt-1 align-item-center ">
          <Col md={4}>
            <Card
            ...
            >
              ...
              <Card.Body>
                <Card.Title  className="project-title">TRAVEL LANDING PAGE </Card.Title>
                <Card.Text className="project-description">
                  
                    Web Application Made by Travelers user friendly, technology like HTML And CSS
          ...
          <Col md={4}>
            ...
            >
              ...
              <Card.Body>
                <Card.Title className="project-title">RESTAURENT LANDING PAGE</Card.Title>
                <Card.Text className="project-description">
                 
                  Web Application user friendly and also responsive,technology like HTML,CSS and Boostrap
            ...
            >
              ...
              <Card.Body>
                ...
                <Card.Text className="project-description">
                    ...
                    Using CRUD operation,technology like,HTML,CSS,Boostrap,reactjs,<br/>Nodejs,MongoDB
